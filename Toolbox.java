...
/** Insieme di strumenti, ciascuno associato a un carattere in modo univoco, e in cui al pi� uno strumento � in ogni istante attivo
 *
 *
 */
public class Toolbox {
   ...
   * 1. se l'evento � di tastiera (� un carattere):
   * 	1.1 se il tasto premuto identifica uno strumento, cambia lo strumento
   * 	1.2 se invece non identifica uno strumento ma si � premuto il tasto "u", annulla l'ultima azione sul canvas
   * 	1.3 se invece non � nulla di tutto ci�, e lo strumento attivo � di disegno, usa il carattere come tratto
   * 2. se l'evento � di mouse (� un clic) e c'� uno strumento attivo, passalo a quello strumento
   *
  ...
  public void ricevi(Evento e) {
	  if (e instanceof EventoDiTastiera) { // 1. caso tastiera
		  ...
		  else if (tastoPremuto == 'u') { // 1.2 se 'u' non � nel toolbox
